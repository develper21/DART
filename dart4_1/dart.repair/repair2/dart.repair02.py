...
def main():
    ...
    ap.add_argument("--out",default="repair02.result.json")
    args=ap.parse_args()
    ...
    expected_verified=sum(
        ...
        if row["expected_graph_verification"] and row["expected_graph_verification"]["exact_verified"]
    )
    ...
    result={
        ...
        "purpose":"verification threshold / floating-point acceptance repair",
        "gates":{
    ...
    print("DART-4.1 repair02: verification threshold integrity")
