#!/usr/bin/env python3
"""
DART-4.5: goal-directed hierarchical algorithm synthesis.
...
class Progress:
    ...
    def update(self, done, phase, detail=""):
        ...
        sys.stdout.write(
            f"\r[DART-4.5][seed {self.idx}/{self.nseeds}] "
...
def main():
    ...
    ap.add_argument("--out", default="dart045_results.json")
    args = ap.parse_args()
    ...
    print("DART-4.5: goal-directed hierarchical algorithm synthesis")
